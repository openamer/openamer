      ...
      let
        ...
        excludedDirs =
          ...
          ++ [
            ...
            "nix"
            # Skills are shipped via OPENAMER_BUNDLED_SKILLS /
            # OPENAMER_OPTIONAL_SKILLS (see openamer-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + OPENAMER_BUNDLED_LOCALES
            # / OPENAMER_OPTIONAL_MCPS, not via the wheel. Excluding them
