# nix/overlays.nix — Expose pkgs.openamer-agent for external NixOS configs
#
...
# `pkgs.openamer-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    openamer-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
