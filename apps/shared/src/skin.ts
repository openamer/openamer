/**
 * Canonical OpenAmer skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$OPENAMER_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`openamer_cli/skin_engine.py`),
 ...
 *   • CLI     → `openamer_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
