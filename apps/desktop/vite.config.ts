...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\openamer\openamer-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@openamer/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@openamer/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@openamer/shared': path.resolve(__dirname, '../shared/src'),
