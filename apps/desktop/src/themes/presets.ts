...
const OPENAMER_BLUE = '#0053FD'
const PSYCHE_BLUE = '#1540B1'
const PSYCHE_WARM = '#FFE6CB'

const openamerTint = (pct: number) => `color-mix(in srgb, ${OPENAMER_BLUE} ${pct}%, #FFFFFF)`
const openamerTintTransparent = (pct: number) => `color-mix(in srgb, ${OPENAMER_BLUE} ${pct}%, transparent)`

/**
 * OpenAmer — canonical OpenAmer desktop identity. The palette keeps the current
 * glass geometry neutral, then lets the old bb/gui blue and psyche cream
 * return as accent seeds.
 */
export const openamerTheme: DesktopTheme = {
  name: 'openamer',
  label: 'OpenAmer',
  description: 'Glass neutrals with OpenAmer blue accents',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
    cardForeground: '#17171A',
    muted: openamerTint(5),
    mutedForeground: '#666678',
    popover: '#FFFFFF',
    popoverForeground: '#17171A',
    primary: OPENAMER_BLUE,
    primaryForeground: '#FCFCFC',
    secondary: openamerTint(7),
    secondaryForeground: '#242432',
    accent: openamerTint(10),
    accentForeground: '#202030',
    border: openamerTintTransparent(22),
    input: openamerTintTransparent(30),
    ring: OPENAMER_BLUE,
    midground: OPENAMER_BLUE,
    composerRing: OPENAMER_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: openamerTintTransparent(18),
    userBubble: openamerTint(6),
    userBubbleBorder: openamerTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
...
export const DEFAULT_SKIN_NAME = 'openamer'
