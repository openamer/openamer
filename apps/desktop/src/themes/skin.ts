/**
 * OpenAmer skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$OPENAMER_HOME/skins/` (or a
 * built-in) resolved by `openamer_cli/skin_engine.py` and pushed to every surface
 ...
 * skin OpenAmer authors from a prompt lights up all three surfaces from one file.
 *
...
import type { OpenAmerSkin, SkinColors } from '@openamer/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: OpenAmerSkin): DesktopTheme | null {
