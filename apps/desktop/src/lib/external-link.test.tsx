...
const desktopWindow = window as unknown as { openamerDesktop?: Window['openamerDesktop'] }
const initialOpenAmerDesktop = desktopWindow.openamerDesktop

function installDesktopBridge(partial: Partial<Window['openamerDesktop']> = {}) {
  desktopWindow.openamerDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['openamerDesktop']
}
...
function installTitleBridge(title: string) {
  ...
  installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['openamerDesktop']['fetchLinkTitle'] })
...
afterEach(() => {
  ...
  if (initialOpenAmerDesktop) {
    desktopWindow.openamerDesktop = initialOpenAmerDesktop
  } else {
    delete desktopWindow.openamerDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['openamerDesktop']['openExternal'] })
