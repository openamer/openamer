...
// hairline `--stroke-openamer` paired with the soft `--shadow-openamer` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-openamer) bg-(--ui-chat-bubble-background) shadow-openamer [-webkit-app-region:no-drag]'
