...
export function buildReviewFlatList(files: OpenAmerReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: OpenAmerReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
