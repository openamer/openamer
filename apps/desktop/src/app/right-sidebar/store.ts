...
const TAKEOVER_KEY = 'openamer.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which OpenAmer can't clear via the API — the user
 *  sees exactly what runs instead of OpenAmer silently deleting their creds. */
