...
import type { OpenAmerReadDirEntry, OpenAmerReadDirResult } from '@/global'
...
export type ProjectTreeEntry = OpenAmerReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: OpenAmerReadDirEntry) {
...
async function filterIgnored(entries: OpenAmerReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<OpenAmerReadDirResult> {
