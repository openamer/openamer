...
import { type DroppedFile, extractDroppedFiles, OPENAMER_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, OPENAMER_PATHS_MIME) ? 'files' : null
