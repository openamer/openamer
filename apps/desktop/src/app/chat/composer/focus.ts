...
const FOCUS_EVENT = 'openamer:composer-focus'
const INSERT_EVENT = 'openamer:composer-insert'
const INSERT_REFS_EVENT = 'openamer:composer-insert-refs'
const SUBMIT_EVENT = 'openamer:composer-submit'
const VOICE_TOGGLE_EVENT = 'openamer:composer-voice-toggle'
