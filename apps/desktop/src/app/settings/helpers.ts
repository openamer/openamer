...
import type { ConfigFieldSchema, OpenAmerConfigRecord, ToolsetInfo } from '@/types/openamer'
...
export function getNested(obj: OpenAmerConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: OpenAmerConfigRecord, path: string, value: unknown): OpenAmerConfigRecord {
...
function personalityOptions(config: OpenAmerConfigRecord): string[] {
...
function commandProviderNames(config: OpenAmerConfigRecord, section: 'tts' | 'stt'): string[] {
