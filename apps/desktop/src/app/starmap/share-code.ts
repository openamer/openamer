...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/openamer'
...
const VERSION = 3
const PREFIX = 'HML' // "OpenAmer Memory Loadout" — namespaces our codes like WoW's leading bytes.
