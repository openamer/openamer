...
const TILES_KEY = 'openamer.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'openamer.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __OPENAMER_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__OPENAMER_SESSION_TILES__ = {
