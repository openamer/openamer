 ...
 * `<openamer home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'openamer.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'openamer.desktop.disabledPlugins.v1'
