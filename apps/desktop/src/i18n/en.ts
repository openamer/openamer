...
export const en: Translations = {
  ...
  boot: {
    ready: 'OpenAmer Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading OpenAmer settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingOpenAmerDesktop: 'Starting OpenAmer Desktop…'
    },
    errors: {
      backgroundExited: 'OpenAmer background process exited.',
      backgroundExitedDuringStartup: 'OpenAmer background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your OpenAmer backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateOpenAmer: 'Update OpenAmer',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting OpenAmer Desktop.',
    ...
    native: {
      ...
      inputBody: 'OpenAmer is waiting for your response.',
      turnDoneTitle: 'OpenAmer finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to OpenAmer defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones OpenAmer writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while OpenAmer is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'OpenAmer asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while OpenAmer was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let OpenAmer follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what OpenAmer is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen OpenAmer, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'OpenAmer checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading OpenAmer configuration...',
    ...
    gateway: {
      ...
      intro:
        'OpenAmer Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running OpenAmer backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset OPENAMER_DESKTOP_REMOTE_URL and OPENAMER_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private OpenAmer backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote OpenAmer backend.',
      ...
      cloudDesc: 'Sign in once to OpenAmer Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'OpenAmer Cloud',
      cloudSignIn: 'Sign in to OpenAmer Cloud',
      cloudSignedIn: 'Signed in to OpenAmer Cloud',
      cloudNeedsSignIn: 'Sign in to OpenAmer Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your OpenAmer Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'OpenAmer Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of OpenAmer Cloud',
      cloudSignedOutMessage: 'Cleared the OpenAmer Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /openamer.',
      ...
      restartingMessage: 'OpenAmer Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · OpenAmer ${version}` : ''}`,
      ...
      sshDesc:
        'OpenAmer is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshOpenAmerPathTitle: 'OpenAmer path (optional)',
      sshOpenAmerPathDesc: 'Full path to the remote openamer binary. Blank = auto-detect.',
      sshOpenAmerPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — OpenAmer found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — OpenAmer runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update OpenAmer on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. OpenAmer runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point OpenAmer at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via openamer curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As OpenAmer builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart OpenAmer to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update OpenAmer to generate pets.',
      backgroundHint: 'You can close this — OpenAmer will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure OpenAmer desktop' },
    ...
    openamerActiveSessions: (version, count) => `OpenAmer ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@openamer:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent OpenAmer environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. OpenAmer will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the OpenAmer backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from OpenAmer. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting OpenAmer...',
    placeholderReconnecting: 'Reconnecting to OpenAmer…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give OpenAmer a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'OpenAmer will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask OpenAmer to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating OpenAmer…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting OpenAmer…',
    ...
    unsupportedMessage: 'This version of OpenAmer can’t update itself from inside the app.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the OpenAmer desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The OpenAmer updater takes over in its own window and reopens OpenAmer automatically when it’s done. Please don’t reopen OpenAmer yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. OpenAmer reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then OpenAmer reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'OpenAmer needs a one-time install',
    ...
    setupChoiceTitle: 'Set up OpenAmer Desktop',
    setupChoiceDesc:
      'Connect this app to a OpenAmer gateway you already run, or install OpenAmer locally on this computer.',
    connectExistingTitle: 'Connect to existing OpenAmer',
    ...
    installLocalTitle: 'Install OpenAmer locally',
    ...
    probeError: 'Could not reach that OpenAmer gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up OpenAmer Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another OpenAmer CLI or desktop instance is running. Stop any running OpenAmer instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with OpenAmer Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'OpenAmer is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting OpenAmer…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run OpenAmer',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — OpenAmer connects automatically',
    ...
    authorizeThere: 'Authorize OpenAmer there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize OpenAmer there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Connected to OpenAmer Cloud at ${host} · click to manage`,
      ...
      gatewayTitle: 'OpenAmer inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. OpenAmer will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'OpenAmer is restarting...',
      askRestart: 'Ask OpenAmer to restart the server',
      lookingRestart: taskId => `OpenAmer is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'OpenAmer is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `OpenAmer finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'OpenAmer could not restart the server.',
      stillWorking:
        'OpenAmer is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'OpenAmer is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'OpenAmer gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.openamer/config.yaml). OpenAmer won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'OpenAmer needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'OpenAmer needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart OpenAmer Desktop to use Save Image.',
    restartToSaveImages: 'Restart OpenAmer Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `openamer gateway` running?'
    }
  },
