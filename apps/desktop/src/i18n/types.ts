...
export type Locale = 'en' | 'zh' | 'zh-hant' | 'ja' | 'ar' | 'de' | 'es' | 'pt' | 'sq' | 'bs' | 'fr' | 'it' | 'tr' | 'ru' | 'hi' | 'fa' | 'uk' | 'ko' | 'id' | 'th' | 'vi' | 'eo' | 'pl' | 'nl' | 'ro' | 'el' | 'cs' | 'sv' | 'hu' | 'bg' | 'da' | 'fi' | 'sk' | 'no' | 'ga' | 'sl' | 'hr' | 'et' | 'lv' | 'lt'
...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingOpenAmerDesktop: string
    }
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshOpenAmerPathTitle: string
      sshOpenAmerPathDesc: string
      sshOpenAmerPathPlaceholder: string
  ...
  commandCenter: {
    ...
    openamerActiveSessions: (version: string, count: number) => string
