...
const SCRIPT: Record<string, { id: string; src: string }> = {
  instagram: { id: 'openamer-ig-embed', src: 'https://www.instagram.com/embed.js' },
  tiktok: { id: 'openamer-tt-embed', src: 'https://www.tiktok.com/embed.js' },
  twitter: { id: 'openamer-tw-embed', src: 'https://platform.twitter.com/widgets.js' }
}
