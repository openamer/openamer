...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @openamer/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@openamer/shared'],
              message: 'Plugins import only @openamer/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
