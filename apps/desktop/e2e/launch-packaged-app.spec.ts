...
/**
 * E2E smoke tests for the packaged OpenAmer desktop app.
 *
 ...
 * (credential stripping, isolated OPENAMER_HOME + userData, unique app name).
 *
...
test('window opens with the OpenAmer title', async () => {
