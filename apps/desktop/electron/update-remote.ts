 ...
 *
 * A public install can end up with `origin=git@github.com:openamer/openamer.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/openamer/openamer.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/openamer/openamer'
