 ...
 * Apps) login to a gated OpenAmer gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (OpenAmer Portal) issues a per-gateway-instance client_id and only
...
// openamer_cli/web_server.py status handler.
