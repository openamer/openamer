...
// even though a fresh shell — and the OpenAmer CLI — sees it immediately. The
// desktop's OPENAMER_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\openamer. Reading
...
//       OPENAMER_HOME    REG_SZ    F:\OpenAmer\data
//
