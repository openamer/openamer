...
cd apps/desktop
XCURSOR_SIZE=24 OPENAMER_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/openamer-typing
# → /tmp/openamer-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/openamer-typing.before.heapsnapshot
# → /tmp/openamer-typing.after.heapsnapshot
```
