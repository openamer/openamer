...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models openamer typically routes
...
def resolve_billing_route(
    ...
    if provider_name == "openamer" or base_url_host_matches(base_url or "", "inference-api.openamer.com"):
        return BillingRoute(provider="openamer", model=model, base_url=base_url or _openamer_DEFAULT_BASE_URL, billing_mode="official_models_api")
