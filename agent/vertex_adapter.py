"""Vertex AI (Google Cloud) adapter for OpenAmer Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows OpenAmer to use Gemini models via Google Cloud with
...
# who installed plain `openamer-agent` and only later selected a Gemini model.
try:
