...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``openamer logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # OpenAmer only initiates compaction in "openamer" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping OpenAmer preflight compression for codex app-server "
                "(mode=%s); OpenAmer will not start thread compaction here.",
