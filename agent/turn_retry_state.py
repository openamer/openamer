...
anthropic, openamer, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    openamer_auth_retry_attempted: bool = False
    openamer_paid_entitlement_refresh_attempted: bool = False
