...
projection into OpenAmer' display, approval bridging, transcript projection into
...
"codex_app_server"`. OpenAmer' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        # `os.environ.copy()` also handed it every Tier-1 OpenAmer secret — gateway
        ...
        spawn_env = openamer_subprocess_env(inherit_credentials=True)
        if env:
    ...
    def initialize(
        self,
        client_name: str = "openamer",
        client_title: str = "OpenAmer Agent",
