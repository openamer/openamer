...
```bash
python3 -m pyfiglet "OPENAMER" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=OPENAMER&font=Slant" | boxes -d stone
```
