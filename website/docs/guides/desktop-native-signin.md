...
description: "How the OpenAmer Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the OpenAmer Desktop app connects to a **gated gateway** (a hosted or
...
For OpenAmer specifically, native sign-in means:
