...
| [`openamer-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-openamer-agent) | Use, configure, theme, extend, and orchestrate OpenAmer Agent. | `autonomous-ai-agents/openamer-agent` |
...
| [`openamer-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-openamer-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/openamer-agent-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .openamer/plans/; no execution. | `software-development/plan` |
