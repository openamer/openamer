...
See the [config reference](https://github.com/openamer/openamer/blob/main/plugins/memory/honcho/README.md) and [Honcho integration guide](https://docs.honcho.dev/v3/guides/integrations/openamer).
...
See [plugin README](https://github.com/openamer/openamer/blob/main/plugins/memory/hindsight/README.md) for the full configuration reference.
