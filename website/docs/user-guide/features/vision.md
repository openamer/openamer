...
:::tip
Portal subscribers get vision-capable models (Claude, GPT-5, Gemini) in the same catalog — no extra credentials needed. See [your hosted provider](/integrations/nous-portal).
:::
