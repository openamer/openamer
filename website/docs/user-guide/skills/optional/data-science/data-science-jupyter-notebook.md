...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing openamer tool access (web_search, file ops). Stateless. |
