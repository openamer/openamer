...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/web-development/page-agent` |
...
- User wants **OpenAmer itself to drive a browser** → use OpenAmer' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
