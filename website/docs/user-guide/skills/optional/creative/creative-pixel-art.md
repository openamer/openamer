...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.openamer/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.openamer/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — OpenAmer installs package this)
