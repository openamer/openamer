...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by OpenAmer Agent |
| License | MIT |
...
Helper script path: ~/.openamer/skills/blockchain/solana/scripts/solana_client.py
