...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | OpenAmer Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $OPENAMER_OSINT_CACHE/icij/ (default: ~/.cache/openamer-osint/icij/).
...
# Set OPENAMER_OSINT_UA=your-app/1.0 (your@email) to identify yourself
