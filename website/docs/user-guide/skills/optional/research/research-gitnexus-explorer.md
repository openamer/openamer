...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/research/gitnexus-explorer` |
...
| Related skills | [`openamer-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-openamer-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  openamer-agent users don't need.
