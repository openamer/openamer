...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), OpenAmer Agent |
| License | MIT |
...
import upstream classes into OpenAmer itself.
...
Open `~/.openamer/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside OpenAmer core.
   Custom driver scripts under `~/.openamer/skills/...` are user-side and fine.
