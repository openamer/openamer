...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`openamer-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-openamer-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
OpenAmer Agent via the native MCP client. This is the preferred
...
Then configure OpenAmer Agent to connect via HTTP:
