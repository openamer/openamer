...
| | |
|---|---|
| Source | Optional — install with `openamer skills install official/health/neuroskill-bci` |
...
Connect OpenAmer to a running [NeuroSkill](https://neuroskill.com/) instance to read
