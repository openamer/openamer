...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to OpenAmer Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to OpenAmer Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying OpenAmer core? Start with [Build a OpenAmer Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for OpenAmer itself? Start with [Adding Tools](./adding-tools.md)
...
```bash
scripts/dev-sandbox.sh python -m openamer_cli.main
scripts/dev-sandbox.sh --persistent python -m openamer_cli.main desktop  # state survives restarts, but lives in the worktree :)
```
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.openamer/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.openamer` — use `get_openamer_home()` from `openamer_constants` for code paths and `display_openamer_home()` for user-facing messages. See [AGENTS.md](https://github.com/openamer/openamer/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/openamer](https://discord.gg/openamer)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/openamer/openamer/blob/main/LICENSE).
