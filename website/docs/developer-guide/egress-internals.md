...
HERMES_HOME=/tmp/openamer-egress-test python3 -m openamer_cli.main egress --help
HERMES_HOME=/tmp/openamer-egress-test python3 -m openamer_cli.main egress setup --help
```
