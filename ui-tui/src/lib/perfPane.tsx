...
//
// Both gate on HERMES_DEV_PERF=1 and dump JSON-lines (default ~/.openamer/perf.log,
...
const LOG_PATH = process.env.HERMES_DEV_PERF_LOG?.trim() || join(homedir(), '.openamer', 'perf.log')
