...
import type { ScrollBoxHandle } from '@openamer/ink'
import { evictInkCaches } from '@openamer/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.OPENAMER_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
