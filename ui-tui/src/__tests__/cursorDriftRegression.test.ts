 ...
 *
 * Symptom: in `openamer --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@openamer/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using openamer --tui and as i type multiline my caret at the end will often ' +
