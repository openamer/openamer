 ...
 * React.createElement.
 *
 * Trust model matches `~/.hermes/plugins/`: files under OPENAMER_HOME execute
...
const widgetsDir = () => join(process.env.OPENAMER_HOME?.trim() || join(homedir(), '.hermes'), 'tui-widgets')
