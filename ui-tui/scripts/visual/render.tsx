 ...
 * across theme x background scenes to <tmpdir>/openamer-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@openamer/ink'
...
// The regenerated slate light_colors block from openamer_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/openamer-agent',
...
const setup = (bgHex: string) => {
  process.env.OPENAMER_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
