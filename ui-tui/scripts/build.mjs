...
await build({
  ...
  // Skip the prebuilt @openamer/ink bundle and inline the source instead:
  ...
  alias: { '@openamer/ink': resolve(root, 'packages/openamer-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The openamer_cli launcher
