...
Built for [OpenAmer Agent](https://github.com/openamer/openamer). Usable in any coding agent. Canonical source lives here; synced to [`openamer/openamer/skills/creative/ascii-video`](https://github.com/openamer/openamer/tree/main/skills/creative/ascii-video) via PR.
