...
Built for [OpenAmer Agent](https://github.com/NousResearch/openamer-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/openamer-agent/skills/creative/ascii-video`](https://github.com/NousResearch/openamer-agent/tree/main/skills/creative/ascii-video) via PR.
