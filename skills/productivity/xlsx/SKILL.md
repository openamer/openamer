...
For full investment-banking conventions (balance checks, sensitivity tables, named ranges), install the optional skill: `openamer skills install official/finance/excel-author`.
