---
name: openamer-agent-skill-authoring
...
3. **Description too generic or trigger buried past char 57.** The system prompt
   ...
   - Good: `Use when debugging OpenAmer skill discovery failures.`
   - Bad: `This skill contains detailed guidance for agents working on OpenAmer skill discovery failures.`
