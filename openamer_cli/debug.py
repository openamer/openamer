...
_NOUS_BUNDLE_FORMAT = "openamer-debug-share/1"
...
def _run_debug_share_nous(args, *, log_lines: int, redact: bool) -> None:
    """Handle ``openamer debug share --nous``: upload the bundle to Nous-S3.
    ...
    if redact:
        logger.info(
            "openamer debug share --nous: applied force-mode redaction before upload"
        )
