...
Used by ``openamer kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``openamer_cli/goals.py`` — same aux
...
OPENAMER_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("OPENAMER_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
...
def _profile_author() -> str:
    ...
    return (
        os.environ.get("OPENAMER_PROFILE")
    ...
    *,
    ...
    try:
        ...
        resp = call_llm(
            ...
            temperature=0.3,
            max_tokens=OPENAMER_KANBAN_SPECIFY_MAX_TOKENS,
