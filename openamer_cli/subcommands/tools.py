"""``openamer tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'openamer tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # openamer tools list [--platform cli]
    ...
    # openamer tools disable <name...> [--platform cli]
    ...
    # openamer tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `openamer tools` runs after you pick a provider that\n"
