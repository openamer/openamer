...
Entry point: ``openamer whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``openamer_cli/main.py``).
...
OpenAmer gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures OpenAmer to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  OpenAmer needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the OpenAmer gateway in another terminal:")
    print("         openamer gateway")
    print()
    ...
    print()
    print("  Docs: https://github.com/openamer/openamer/blob/main/website/docs/user-guide/")
