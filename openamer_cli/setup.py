...
# display_hermes_home imported lazily at call sites (stale-module safety during openamer update)
...
def _setup_telegram_auto_result():
    ...
    try:
        profile_name = _profile_name_from_hermes_home(Path(get_openamer_home()))
    except Exception:
        pass
