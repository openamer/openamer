...
_DOCS_BASE = "https://openamer-agent.nousresearch.com/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://openamer-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://openamer-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
