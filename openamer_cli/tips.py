...
TIPS = [
    ...
    # --- MCP ---
    "openamer mcp opens an interactive picker of Nous-approved MCPs you can install in one keystroke.",
    "openamer mcp catalog lists Nous-approved MCP servers shipped with the repo.",
    ...
    "openamer auth add nous or openamer auth add openai-codex sets up OAuth-based providers.",
