...
SPOTIFY_DOCS_URL = "https://openamer-agent.nousresearch.com/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "https://openamer-agent.nousresearch.com/docs/guides/oauth-over-ssh"
