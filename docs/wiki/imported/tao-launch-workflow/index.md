...
description: Shared launch intake for any TAO workflow or action. Use when the user wants to run TAO AutoML, train, evaluate, infer, 
---
...
**Lines:** 396 | **Code:** 53 | **Dir:** `tao-launch-workflow`
...
description: >-
  ...
  to run TAO AutoML, train, evaluate, infer, export, generate TensorRT engi...