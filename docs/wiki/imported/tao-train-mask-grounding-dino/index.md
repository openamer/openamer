...
description: Mask Grounding DINO for grounded instance segmentation. Extends Grounding DINO with a mask-prediction head for open-set 
---
...
**Lines:** 209 | **Code:** 27 | **Dir:** `tao-train-mask-grounding-dino`
...
description: Mask Grounding DINO for grounded instance segmentation. Extends Grounding DINO with a mask-prediction head for
  open-set segmentation guided by te...