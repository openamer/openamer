...
description: Optical Inspection for defect detection using Siamese networks. Compares image pairs to detect manufacturing defects, an
---
...
**Lines:** 199 | **Code:** 33 | **Dir:** `tao-train-optical-inspection`
