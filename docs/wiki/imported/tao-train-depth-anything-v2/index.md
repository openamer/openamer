...
description: Monocular depth estimation using Metric Depth Anything v2 or Relative Depth Anything architectures. Predicts per-pixel d
---
...
**Lines:** 233 | **Code:** 25 | **Dir:** `tao-train-depth-anything-v2`
