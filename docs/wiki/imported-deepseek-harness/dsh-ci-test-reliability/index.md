---
title: dsh-ci-test-reliability
description: Design, review, and diagnose DeepSeek Harness tests and fixtures that can fail nondeterministically under CI concurrency
---
...
**Lines:** 132 | **Code:** 0 | **Dir:** `dsh-ci-test-reliability`

---

---
name: dsh-ci-test-reliability
description: Design, review, and diagnose DeepSeek Harness tests and fixtures that can fail nondeterministically under CI concurrency, shared host resources, clocks, ...