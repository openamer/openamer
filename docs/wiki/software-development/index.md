...
- [adapting-external-skills](adapting-external-skills/) — Port skills or code from external/upstream projects into OpenAmer.
...
- [browser-brick-recovery](browser-brick-recovery/) — Browser bricked by JS prompt dialog? Recover + probe safely.
...
- [cross-process-jsonl-store](cross-process-jsonl-store/) — Use when cron processes share a JSONL store: lock it.
...
- [desktop-i18n-locale](desktop-i18n-locale/) — Use when adding a UI locale to OpenAmer desktop i18n files.
- [desktop-i18n-locale-add](desktop-i18n-locale-add/) — Use when adding a UI language locale to the desktop picker.
- [desktop-i18n-locale-addition](desktop-i18n-locale-addition/) — Use when adding a UI language/locale to OpenAmer desktop.
...
- [event-kernel-agent-runtime](event-kernel-agent-runtime/) — Use when building or debugging event-kernel agent runtimes.
- [evolutionary-skill-engineering](evolutionary-skill-engineering/) — Use when evolving skill populations via the Darwin Engine.
- [failure-attribution](failure-attribution/) — Use after a red test/build run: prove whose failure it is.
...
- [openamer-docs-site](openamer-docs-site/) — Use when adding or editing OpenAmer docs-site pages.
...
- [training-scripts-hygiene](training-scripts-hygiene/) — Use when editing scripts/training/ — paths, thinking, sync.
...
- [windows-handle-contention](windows-handle-contention/) — Use when WinError 5/32: a file/dir op fails permanently.
- [windows-installer-release](windows-installer-release/) — Use to build + publish the OpenAmer Windows NSIS installer.
