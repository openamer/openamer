...
- [codebase-inspection](codebase-inspection/) — Inspect codebases w/ pygount: LOC, languages, ratios.
- [github-api-automation](github-api-automation/) — Script GitHub via REST API without gh/CLI login.
...
- [github-issue-updater](github-issue-updater/) — Post verified feature updates to own GitHub issues via cron.
