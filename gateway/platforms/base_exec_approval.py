...
the same three things: what OpenAmer wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "OpenAmer wants to run a command that needs your OK"
