...
_APP_VERSION = _OPENAMER_VERSION
_BOT_VERSION = _OPENAMER_VERSION
_YUANBAO_INSTANCE_ID = str(OPENAMER_INSTANCE_ID)  # single source: yuanbao_proto.OPENAMER_INSTANCE_ID
