...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$OPENAMER_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_openamer_dir("platforms/whatsapp/session", "whatsapp/session")
