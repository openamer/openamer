...
class GatewayKanbanWatchersMixin:
    ...
    def _kanban_sub_op(self, board: Optional[str], op: str, sub: dict, **extra: Any) -> None:
        ...
        from openamer_cli import kanban_db_connect as _kbc
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        loop exits and an external `openamer kanban daemon` is expected. Each
        ...
        while self._running:
            try:
                ...
                from openamer_cli import kanban_db_dispatch as _kbd
            ...
            try:
                # Emergency stop (`openamer pause`): no auto-decompose or
