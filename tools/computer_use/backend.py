...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of openamer/openamer#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of openamer/openamer#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (openamer/openamer#67052). ``ok`` stays
