...
Trust levels:
  - builtin:   Ships with OpenAmer. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.openamer/\.env|\~/\.openamer/\.env',
     "openamer_env_access", "critical", "exfiltration",
     "directly references OpenAmer secrets file"),
    ...
    (r'\.openamer/config\.yaml|\.openamer/SOUL\.md',
     "openamer_config_mod", "critical", "persistence",
     "references OpenAmer configuration files directly"),
...
# scan. `.skillignore` is the OpenAmer-native name; `.clawhubignore` is honored
