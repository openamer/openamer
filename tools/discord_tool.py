...
Only included in the openamer-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "OpenAmer-Agent (https://github.com/NousResearch/openamer-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_openamer_home() / "cache" / "discord_capabilities.json"
