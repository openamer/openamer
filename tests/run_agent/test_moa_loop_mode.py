...
def test_moa_slots_routed_through_resolve_runtime_provider(monkeypatch):
    ...
    monkeypatch.setattr(
        "openamer_cli.runtime_provider.resolve_runtime_provider", fake_resolve
    )
...
def test_moa_provider_backed_slot_survives_aux_resolution(monkeypatch, provider):
    ...
    bedrock, openamer, openai-codex, xai-oauth) are intentionally NOT forwarded —
...
def test_moa_slot_runtime_falls_back_on_resolution_error(monkeypatch):
    ...
    monkeypatch.setattr(
        "openamer_cli.runtime_provider.resolve_runtime_provider", boom
    )
