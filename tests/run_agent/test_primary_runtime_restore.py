...
5. Recovery is skipped for aggregator providers (OpenRouter, OpenAmer)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_skipped_for_openamer_provider(self):
        agent = _make_agent(provider="openamer", base_url="https://inference.openamer.openamer.com/v1")
        error = _make_transport_error("ReadTimeout")
