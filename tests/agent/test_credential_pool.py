...
def test_is_terminal_xai_oauth_refresh_error():
    from openamer_cli.auth import AuthError, _is_terminal_xai_oauth_refresh_error
...
def test_is_terminal_codex_oauth_refresh_error():
    from openamer_cli.auth import AuthError, _is_terminal_codex_oauth_refresh_error
