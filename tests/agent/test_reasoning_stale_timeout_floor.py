...
thinking phase.  OpenAmer's default cloud-stream stale detector
(``OPENAMER_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``OPENAMER_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
