...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_openamer_user(self):
        """Without user_id or config override, should default to 'openamer-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "openamer-user"
...
class TestAIAgentUserIdPropagation:
    ...
    def test_user_id_stored_on_agent(self):
        ...
        with patch.dict(os.environ, {"OPENAMER_HOME": "/tmp/test_openamer"}):
