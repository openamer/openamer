...
def test_jwks_url_path_resolves_key(rsa_keys, monkeypatch):
    ...
    class FakeJWKClient:
        def __init__(self, url):
            assert url == "https://portal.openamer.com/.well-known/jwks.json"
    ...
    claims = verify_nas_fire_token(
        ...
        jwks_or_key="https://portal.openamer.com/.well-known/jwks.json",
        issuer=ISS,
    )
...
def test_jwks_client_is_cached_across_calls(rsa_keys, monkeypatch):
    ...
    priv, pub = rsa_keys
    url = "https://portal.openamer.com/.well-known/jwks.json"
