...
def sample_recording():
    ...
    recording.actions = [
        {"action": "click", "coordinate": [100, 200], "delay": 0.5},
        {"action": "type", "text": "hello world", "delay": 0.3},
    ]
...
class TestRecordingStore:
    def test_save_and_load(self):
        ...
        recording.actions = [{"action": "click", "coordinate": [10, 20]}]
        RecordingStore.save(recording)
    ...
    def test_save_and_load_roundtrip(self):
        ...
        rec.actions = [{"action": "key", "keys": "cmd+s"}]
    ...
    def test_list_empty(self):
        recordings = RecordingStore.list_recordings()
        # Only our temp home is empty — may have extra in real home, so just check structure
...
class TestComputerUseRecording:
    ...
    def test_to_dict_roundtrip(self):
        rec = ComputerUseRecording(name="roundtrip", description="testing")
        rec.actions = [{"action": "key", "keys": "cmd+s"}]
        d = rec.to_dict()
