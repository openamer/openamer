...
The unit tests in tests/openamer_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned openamer-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/openamer")
from openamer_cli.service_manager import S6ServiceManager
