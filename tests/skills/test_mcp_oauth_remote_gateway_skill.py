...
SESSION_REVOKED / REFRESH_DEAD), the OPENAMER_HOME resolution fallback, the
...
def _run_main(mod, tokens_dir, argv, responses):
    ...
    with patch.object(mod.os, "environ", dict(mod.os.environ, OPENAMER_HOME=str(tokens_dir.parent))), \
