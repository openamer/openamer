...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (openamer_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_openamer_overlays():
    """openamer_cli.providers.get_provider("vertex") backs
