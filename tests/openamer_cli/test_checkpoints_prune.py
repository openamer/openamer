"""Tests for `openamer checkpoints prune`'s orphan confirmation flow.
...
_PRE_V2_ONLY_STATUS = {
    "projects": [],
    "pre_v2_projects": [
        {"path": "/home/user/.openamer/checkpoints/deadbeefcafebabe", "workdir": None, "exists": False},
    ],
}
...
_MIXED_STATUS = {
    ...
    "pre_v2_projects": [
        {"path": "/home/user/.openamer/checkpoints/deadbeefcafebabe", "workdir": "/gone/pre-v2-project", "exists": False},
    ],
}
...
def test_nonempty_preview_allowlist_matches_displayed_set(monkeypatch, capsys):
    ...
    assert prune_calls[0]["orphan_allowlist"] == {
        "abc123",
        "/home/user/.openamer/checkpoints/deadbeefcafebabe",
    }
