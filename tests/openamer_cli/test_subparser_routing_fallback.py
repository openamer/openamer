...
The main() function in openamer_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `openamer -c model`
...
def _build_parser():
    """Build a minimal replica of the openamer top-level parser."""
