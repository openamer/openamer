...
def test_has_hermes_agent_browser_windows_path(tmp_path):
    ...
    from openamer_cli.dep_ensure import _has_hermes_agent_browser
    with patch("openamer_cli.dep_ensure._IS_WINDOWS", True), \
         patch("openamer_constants.get_hermes_home", return_value=tmp_path):
...
def test_ensure_dependency_uses_powershell_on_windows(tmp_path):
    ...
    with patch("openamer_cli.dep_ensure._IS_WINDOWS", True), \
         ...
         patch("openamer_cli.dep_ensure.shutil") as mock_shutil, \
         patch("openamer_constants.get_hermes_home", return_value=tmp_path / "fakehome"), \
