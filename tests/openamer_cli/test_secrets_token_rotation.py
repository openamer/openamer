"""Tests for `openamer secrets bitwarden token` / `openamer secrets onepassword token`.
...
from openamer_cli import onepassword_secrets_cli as op_cli
from openamer_cli import secrets_cli as bw_cli
