...
hand-rolled parsers — ``openamer_cli.config.load_env``,
``openamer_cli.main._has_any_provider_configured``, and
...
def test_skills_tool_load_env_strips_export_prefix(tmp_path, monkeypatch):
    ...
    # skills_tool.load_env reads get_openamer_home()/.env directly.
    import importlib
...
def test_has_any_provider_configured_with_export_prefix(tmp_path, monkeypatch):
    ...
    import openamer_cli.main as hmain
