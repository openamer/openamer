"""Tests for the specifier module + `openamer kanban specify` CLI surface.
...
from openamer_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `openamer kanban …` argparse surface directly."""
