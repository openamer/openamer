...
def test_s6_lifecycle_persists_default_profile_desired_state(
    ...
    monkeypatch.setenv("OPENAMER_HOME", str(hermes_home / "profiles" / "coder"))
...
def test_s6_log_run_chowns_gateways_parent(s6_scandir, fake_subprocess_run) -> None:
    ...
    parent_chown = 'chown hermes:hermes "$OPENAMER_HOME/logs/gateways"'
    ...
    assert 'chown -R hermes:hermes "$OPENAMER_HOME/logs/gateways"' not in log_text
