"""Tests for openamer_cli.security_advisories.
...
import openamer_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full openamer_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "openamer_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "openamer_cli.config.save_config",
