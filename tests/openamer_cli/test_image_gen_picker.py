...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_openamer_active_label(self, monkeypatch):
        from openamer_cli import tools_config
        ...
        assert tools_config._is_provider_active(openamer_row, config) is False
