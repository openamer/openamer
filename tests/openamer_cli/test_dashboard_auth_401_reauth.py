...
from openamer_cli.dashboard_auth.base import ProviderError, RefreshExpiredError
...
class TestTransparentRefreshOnAccessTokenEviction:
    ...
    def _build_rt_only_app(self):
        ...
        """
        import time as _t
        from tests.openamer_cli.conftest_dashboard_auth import _sign
    ...
    def test_provider_hint_routes_refresh_to_token_owner(self, gated_app):
        """A OpenAmer-style RT must not be rejected by Basic just because Basic
...
class TestAutoSsoRedirect:
    ...
    from openamer_cli.dashboard_auth.cookies import SSO_ATTEMPT_COOKIE
    ...
    def test_multiple_providers_render_chooser_not_auto_sso(self, gated_app):
        ...
        from tests.openamer_cli.conftest_dashboard_auth import StubAuthProvider
        from openamer_cli.dashboard_auth import register_provider
...
class TestNextSameOriginValidation:
    ...
    def test_safe_next_validator_accepts_same_origin(self):
        from openamer_cli.dashboard_auth.middleware import _safe_next_target
...
class TestValidatePostLoginTarget:
    ...
    def test_accepts_same_origin_paths(self):
        from openamer_cli.dashboard_auth.routes import _validate_post_login_target
