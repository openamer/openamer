...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from openamer_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in OPENAMER_OVERLAYS
        overlay = OPENAMER_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify openamer doctor recognizes Xiaomi env vars."""
