"""Session <-> workspace grouping key (openamer_state.workspace_key).

The key is what `openamer sessions list --workspace` groups/filters on. It is a
...
from openamer_state import workspace_key
