...
def fake_world(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(darwin, "FITNESS_FILE",
                        home / "reports" / "darwin-fitness.json")
    monkeypatch.setattr(darwin, "REPORT_FILE",
                        home / "reports" / "darwin-report.md")
    monkeypatch.setattr(darwin, "PROBE_FILE",
                        home / "reports" / "darwin-probe.json")
