...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("OPENAMER_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("OPENAMER_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("OPENAMER_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
