...
def patch_startup_side_effects(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("openamer_cli.plugins.discover_plugins", lambda: None)
...
async def test_start_gateway_does_not_start_cron_after_aborted_startup(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("openamer_logging.setup_logging", lambda openamer_home, mode: None)
