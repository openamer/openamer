...
def make_adapter_skeleton(
    *,
    ...
    # _admit() reads this; without it every DM-admission test dies with
    # AttributeError. _apply_settings mirrors it generically as self._<field>,
    # so a real adapter always has it — only this hand-built skeleton missed it.
