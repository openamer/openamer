#!/usr/bin/env python3
"""
SWE Runner with OpenAmer Trajectory Format

A runner that uses OpenAmer-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the OpenAmer-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses OpenAmer-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in OpenAmer format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches OpenAmer-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using OpenAmer-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with OpenAmer Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses OpenAmer-Agent's built-in execution environments
    and outputs trajectories in OpenAmer-Agent format.
    """
    ...
    def _convert_to_openamer_format(
        self,
        ...
        """
        Convert internal message format to OpenAmer trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to OpenAmer trajectory format
        trajectory = self._convert_to_openamer_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with OpenAmer trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with OpenAmer Trajectory Format")
    print("=" * 60)
