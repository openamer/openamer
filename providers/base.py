...
def _profile_user_agent() -> str:
    """Return a ``openamer-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from openamer_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"openamer-cli/{_ver}"
    except Exception:
        return "openamer-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # openamer-cli UA so the catalog endpoint is reachable.
