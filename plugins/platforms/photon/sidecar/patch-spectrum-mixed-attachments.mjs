...
// `message.content.text` before OpenAmer can see it. We rewrite the two inbound
...
const MARKER = "OpenAmer patch: Preserve mixed text + attachment iMessage payloads";
