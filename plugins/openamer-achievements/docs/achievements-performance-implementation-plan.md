# OpenAmer Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.openamer/plugins/openamer-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.openamer/plugins/openamer-achievements/scan_checkpoint.json`.
