...
``_check_spotify_available()`` — when the user has not run ``openamer auth
spotify``, the tools remain registered (so they appear in ``openamer
...
The Spotify auth flow (``openamer auth spotify``), CLI plumbing, and docs
