...
DEFAULT_DATASETS = [
    "openamer/swe-terminus-agent-glm-kimi-minimax",
    "openamer/openamer-megascience-sft1",
    "openamer/OpenAmer-Agent-Thinking-GLM-4.7-SFT2",
    "openamer/OpenAmer-Agent-Thinking-GLM-4.7-SFT1",
    "openamer/terminal-tasks-glm-openamer-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "openamer/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload openamer/{output_name} {final_output}")
