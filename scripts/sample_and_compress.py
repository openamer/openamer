...
DEFAULT_DATASETS = [
    ...
    "NousResearch/openamer-agent-megascience-sft1",
    "NousResearch/OpenAmer-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/OpenAmer-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-openamer-agent"
]
