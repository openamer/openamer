...
# internet_learn_log / longterm_episodes (16,068 JSONL rows), the 2,049 quoted
# literals of `tests/scripts/test_internet_learner_gate.py` and 924 repo docs
# files: 1 hit -- the leaking row -- and 0 everywhere else; 0 FPs across 10
# hostile prose controls that cite prices, tiers, star ratings and per-seat
# billing.
...
# an aggregator card's affordance rail welded to the card (class 141, 22.09.26)
    ...
    if _is_de_pricing_chrome(t):
        return True
    # the ENGLISH twin of that class: a plan-comparison price table
    # with rating widgets welded on (class 168, 23.09.26)
