...
# Configuration
REPO_URL_SSH="git@github.com:NousResearch/openamer-agent.git"
REPO_URL_HTTPS="https://github.com/NousResearch/openamer-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://openamer-agent.nousresearch.com/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
