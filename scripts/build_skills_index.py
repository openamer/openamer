#!/usr/bin/env python3
"""Build the OpenAmer Skills Index — a centralized JSON catalog of all skills.
...
`openamer skills search/install` can use it without hitting the GitHub API.
...
# Ensure OPENAMER_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("OPENAMER_HOME", os.path.join(os.path.expanduser("~"), ".openamer"))
...
def main():
    print("Building OpenAmer Skills Index...", flush=True)
