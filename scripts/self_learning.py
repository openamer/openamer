...
if __name__ == "__main__":
    ...
    # warned about a leak and claimed learning in the same breath. Reproduced
    # 2026-09-23 with epochs=1 over a crafted inverted leak: acc=0.714,
    # leak=['tool_name'] -> this acc-gate printed "hat gelernt".
    ...
    if must_warn(findings, acc):
        ...
        print("   Ziel 'Rolle der NÄCHSTEN Message', Temporal-Split 70/30, n≈4.6k →")
        print("   Held-out-Accuracy überschritt die Mehrheitsklassen-Baseline in")
        print("   KEINEM von 5 Runs (bester Edge +0.000). Der Engpass ist die")
