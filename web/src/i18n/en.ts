...
export const en: Translations = {
  ...
  status: {
    ...
    updateOpenAmerConfirmMessage:
      "This runs openamer update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateOpenAmerConfirmNow: "Update now",
    updateOpenAmerConfirmTitle: "Update OpenAmer?",
    updatingOpenAmer: "Updating OpenAmer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update OpenAmer plugins (`openamer plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.openamer/plugins/?",
    removeHint: "Only user-installed plugins under ~/.openamer/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.openamer/skills/",
  ...
  config: {
    configPath: "~/.openamer/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that OpenAmer doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "OpenAmer Achievements",
      subtitle:
        "Collectible OpenAmer badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning OpenAmer session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run OpenAmer more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once OpenAmer sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "OpenAmer is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
