 ...
 *
 * Plugins call window.__OPENAMER_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__OPENAMER_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__OPENAMER_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__OPENAMER_PLUGIN_SDK__ = {
    ...
    // window.__OPENAMER_SESSION_TOKEN__ directly.
    authedFetch,
