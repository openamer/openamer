 ...
 * `window.__OPENAMER_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the OpenAmer brand in the top bar
 ...
 *  `window.__OPENAMER_PLUGINS__.registerSlot(...)`.
 *
