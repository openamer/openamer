...
const STORAGE_KEY = "openamer-dashboard-theme";
...
const FONT_STORAGE_KEY = "openamer-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + OpenAmer-blue rebrand.
  "lens-5i": "openamer-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `openamer_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "openamer-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-openamer-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-openamer-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. OpenAmer Blue) doesn't leave its values behind when the user
