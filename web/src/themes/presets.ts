 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `openamer_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "OpenAmer Teal",
  description: "Classic dark teal — the canonical OpenAmer look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "OpenAmer Teal (Large)",
  description: "OpenAmer Teal with bigger fonts and roomier spacing",
