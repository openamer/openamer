...
import {
  ...
  CardHeader,
  CardTitle,
} from "@openamer-research/ui/ui/components/card";
...
const PROVIDER_GROUPS: { prefix: string; name: string; priority: number }[] = [
  // OpenAmer Portal first
  { prefix: "OPENAMER_", name: "OpenAmer Portal", priority: 0 },
  // Then alphabetical by display name
  { prefix: "ANTHROPIC_", name: "Anthropic", priority: 1 },
  { prefix: "DASHSCOPE_", name: "DashScope (Qwen)", priority: 2 },
  { prefix: "OPENAMER_QWEN_", name: "DashScope (Qwen)", priority: 2 },
...
// Mirror of the backend env-name guard (openamer_cli/config.py _ENV_VAR_NAME_RE).
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-1">
          <p className="text-sm text-muted-foreground">
            {t.env.description} <code>~/.openamer/.env</code>
          </p>
