 ...
 *
 * Values mirror openamer_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the OpenAmer default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (OpenAmer' default when unset). */
